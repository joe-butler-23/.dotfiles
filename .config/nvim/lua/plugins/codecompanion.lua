return {
...

  {
    ...
    dependencies = {
      ...
      -- If you removed legendary.nvim entirely, you might also remove it from dependencies if it was listed here
      ...
      adapters = {
        anthropic = function()
          return require("codecompanion.adapters").extend("anthropic", {
            ...
            schema = {
              model = {
                -- You might want to set a default model here, e.g., "claude-3-5-sonnet-20240620"
...
I'm also sharing my `config.lua` file which I'm mapping to the `configuration` section of the sidebar.
      ...
      strategies = {
        chat = {
          adapter = "openai", -- Changed adapter from 'copilot' to 'openai'
          roles = {
            user = "joe",
          },
          keymaps = {
        ...
        inline = { adapter = "openai" }, -- Changed adapter from 'copilot' to 'openai'
      },
      display = {
        action_palette = {
          provider = "default",
    ...
    init = function()
      ...
      -- Removed the require("legendary").keymaps call
      -- Removed the require("plugins.custom.spinner"):init() call
    end,
  },
}
